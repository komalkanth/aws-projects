...
In this step, we will set up an SNS topic and subscription to receive email notifications for GuardDuty findings. This will allow us to be alerted whenever a new finding is generated by GuardDuty.
